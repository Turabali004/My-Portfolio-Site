...
function Parallex({type}) {
  ...
  return (
    <div ref={ref} className='w-screen h-screen mt-48 relative flex justify-center items-center ' style={{background: type==="services" ? "linear-gradient(180deg, #111132, #0c0c1d)" :
        "linear-gradient(180deg, #111132, #0c0c1d)"
     }}>
        <motion.h1 style={{y: yText}} className='text-7xl font-semibold'>{type === "services" ? "My-projects" : "contact with me"}</motion.h1>
